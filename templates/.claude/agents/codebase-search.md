...
tools: Bash, Glob, Grep, Read, WebFetch, TodoWrite, WebSearch, Skill, LSP, mcp__plugin_context7_context7__resolve-library-id, mcp__plugin_context7_context7__query-docs, ListMcpResourcesTool, ReadMcpResourceTool, mcp__grep-app__searchGitHub
model: haiku
color: cyan
---
