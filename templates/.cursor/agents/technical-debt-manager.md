...
description: Default technical debt subagent for Python projects. Use proactively for refactoring, maintainability, typing debt, test debt, dependency risk, architecture drift, infrastructure debt, and code health reviews; trigger after major changes and during sprint planning.
model: inherit
---
