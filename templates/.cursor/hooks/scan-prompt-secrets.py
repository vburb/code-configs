#!/usr/bin/env python3
"""
Cursor beforeSubmitPrompt hook: scans prompts for leaked secrets before submission.
...
SECRET_PATTERNS = [
    ...
    # Azure
    (r"[a-zA-Z0-9+/]{86}==", "Azure Storage Key (base64)"),
...
def main() -> None:
    ...
    if found_secrets:
        ...
        secret_list = "\n  • ".join(unique_secrets)
        output_block(f"⚠️ Potential secrets detected in prompt:\n  • {secret_list}\n\nPlease remove sensitive data before submitting.")
        sys.exit(0)
